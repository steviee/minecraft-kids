/**
 * WebSocket TypeScript type definitions
...
/**
 * Authenticated WebSocket with user information
 */
...
/**
 * WebSocket upgrade request with authentication
 */
export interface WSUpgradeRequest extends IncomingMessage {
  url: string;
}
